    ...
    <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      ...
      <Tabs defaultValue="map" className="w-full">
        <div className="overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0">
          <TabsList className="flex w-full gap-1 h-auto p-1 bg-card border-border shadow-sm rounded-xl">
        ...
        <TabsContent value="map" className="mt-6 space-y-4">
          <Tabs defaultValue="display" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-4 bg-card border-border shadow-sm rounded-xl">
