...
export const OverlayToggle = ({ overlays, onOverlayChange, onClose, availableLayers }: OverlayToggleProps) => {
    ...
    return (
        <div className="fixed inset-y-0 right-0 z-[1200] w-80 bg-popover/95 border-border shadow-lg shadow-lifted pointer-events-auto overflow-y-auto border-l">
            <div className="sticky top-0 bg-card border-border shadow-sm border-b px-4 py-3 flex items-center justify-between z-10">
