...
import { Search, Navigation, Filter as FilterIcon, Layers, Share2, Download,
...
export const ModernMapOverlay = ({
 ...
 <div className="flex items-center gap-2 bg-popover/95 border-border shadow-lg rounded-2xl px-3 py-2 pointer-events-auto">
 {/* Search Button */}
 <Button
 ...
 variant={drawingActive ? 'default' : 'ghost'} size="sm" className="h-9 w-9 p-0" title="Alat Gambar & Ukur"
 >
 ...
 <div className="bg-popover/95 border-border shadow-lg rounded-2xl px-3 py-2 pointer-events-auto">
 {drawToolbarContent}
 </div>
 </div>
 )}
 ...
 <div className="w-full max-w-2xl bg-popover/95 border-border shadow-lg rounded-2xl px-4 py-3 pointer-events-auto">
 ...
 <div className="bg-card border-border shadow-sm shadow-lifted rounded-xl overflow-hidden pointer-events-auto max-w-xs border border-border">
 {/* Legend Header */}
 <button
