...
export function MultiLayerHeatmap({ points, enabled, categories }: MultiLayerHeatmapProps) {
 ...
 size="sm"
 variant="outline"
 className="bg-white/95 dark:bg-slate-900/95 shadow-lg"
 ...
 {showControls && (
 <div className="absolute top-16 left-4 z-[1000] bg-white/95 dark:bg-slate-900/95 border rounded-lg shadow-md p-4 w-80 max-h-[calc(100vh-120px)] overflow-y-auto">
