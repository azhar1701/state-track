    ...
    <nav className="sticky top-0 z-50 w-full border-b border-primary-foreground/10 bg-primary text-primary-foreground backdrop-blur-md shadow-md">
      <div className="container flex h-16 items-center">
        ...
        <Link to="/" className="flex items-center gap-2 mr-6">
          ...
          <span className="hidden font-bold text-lg text-primary-foreground sm:inline-block tracking-wide">
            SIPASDA
          </span>
        </Link>
                ...
                >
                  {link.active && (
                    <motion.div
                      ...
                      className="absolute inset-x-2 -bottom-1.5 h-1 bg-accent rounded-t-sm"
                      transition={{
                        type: "spring",
                        stiffness: 380,
                        damping: 30,
          ...
          {user ? (
            <>
              <Link to="/report">
                <Button
                  size="sm"
                  className="gap-2 hidden md:flex bg-accent text-accent-foreground hover:bg-accent/90 shadow-md"
                >
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent
                  align="end"
                  className="w-80 sm:w-72 md:w-80 max-w-[90vw]"
                >
