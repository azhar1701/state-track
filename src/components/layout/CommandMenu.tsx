...
const CommandMenu = () => {
  ...
  const prefetchMap = () => import("@/features/map/MapView");
  const prefetchReport = () => import("@/features/reports/ReportForm");
  const prefetchAdmin = () => import("@/features/admin/AdminDashboard");
